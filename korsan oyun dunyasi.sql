...
CREATE TABLE IF NOT EXISTS `oyun` (
  ...
  `kapak` varchar(50) DEFAULT NULL,
  `sistem gereksinimi` int(11) DEFAULT NULL,
  `yas_siniri` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `yayinci` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `yayinci_` varchar(50) NOT NULL DEFAULT '0',
  `yayinci personel sayisi` int(11) NOT NULL DEFAULT 0,
  `kurulus_yili` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
